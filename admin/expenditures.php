...
FROM expenditures
LEFT JOIN projects
    ON expenditures.project_id = projects.project_id
WHERE expenditures.record_status='active'
AND (
    expenditures.reference_no LIKE '%$search%'
    OR expenditures.category LIKE '%$search%'
    OR projects.project_title LIKE '%$search%'
)
";
...
LEFT JOIN budgets
    ON expenditures.budget_id = budgets.budget_id

LEFT JOIN projects
    ON expenditures.project_id = projects.project_id

LEFT JOIN users
    ON expenditures.created_by = users.user_id
WHERE
    expenditures.record_status='active'
    AND (
    expenditures.reference_no LIKE '%$search%'
    OR expenditures.category LIKE '%$search%'
    OR projects.project_title LIKE '%$search%'
                ...
                <div class="row g-0">
                    <div class="col-12 col-xl-6 p-2 mt-3">
                        <div class="d-flex justify-content-start ">
                            <a href="add-expenditure.php" class="btn text-light px-4 py-2 shadow border border-gray"
                        ...
                        <div class="d-flex justify-content-between align-items-center me-3 ">
                            ...
                            <form method="GET" class="d-flex gap-2 expenditure-search-form">
                                ...
                                <input type="text" name="search" class="form-control"
                                    placeholder="Search expenditure..." value="<?= htmlspecialchars($search) ?>"
                                    style="width:250px;">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive ">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php while ($row = mysqli_fetch_assoc($query)) { ?>
                                                            <tr>
                                                                ...
                                                                <td data-label="#"><?= $row['expenditure_id']; ?></td>

                                                                <td data-label="Date">
                                                                    <?= date('M d, Y', strtotime($row['expenditure_date'])); ?>
                                                                </td>

                                                                <td data-label="Reference No."><?= $row['reference_no']; ?></td>
                                                                <td data-label="Category"><?= $row['category']; ?></td>
                                                                <td data-label="Project"><?= $row['project_id']; ?></td>
                                                                <td data-label="Description"><?= $row['description']; ?></td>
                                                                <td data-label="Amount">
                                                                    ₱<?= number_format($row['amount'], 2); ?>
                                                                </td>
                                                                <td data-label="Payment Method"><?= $row['payment_method']; ?></td>
                                                                ...
                                                                <td data-label="Actions">
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <button class="btn action-btn text-dark me-2"
                                                                            ...
                                                                            data-bs-target="#editModal<?= $row['expenditure_id']; ?>">
                                                                        ...
                                                                        <button class="btn action-btn text-light"
                                                                            ...
                                                                            data-bs-toggle="modal"
                                                                            data-bs-target="#deleteModal<?= $row['expenditure_id']; ?>">
                                                ...
                                                ?>
                                                    ...
                                                    <div class="modal fade" id="deleteModal<?= $row['expenditure_id']; ?>"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center">
                                                                    ...
                                                                    <p class="mt-3">
                                                                        ...
                                                                        <strong><?= htmlspecialchars($row['reference_no']); ?></strong>?
                                                                    </p>

                                                                    <small class="text-muted">
                                                                        This expenditure will be hidden from active records
                                                                        but
                                                    ...
                                                    <div class="modal fade" id="editModal<?= $row['expenditure_id']; ?>"
                                                        tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
                                                            ...
                                                            <div class="modal-content border-0 shadow"
                                                                ...
                                                                <form method="POST">
                                                                        ...
                                                                        <div class="card border-0">
                                                                            ...
                                                                            <div class="card-body">
                                                                                ...
                                                                                <div class="section-title">
                                                                                    ...
                                                                                    <h5>1. Expenditure Information</h5>
                                                                                </div>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-6 mb-4">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            class="form-control"
                                                                                            value="<?= htmlspecialchars($row['reference_no']); ?>"
                                                                                            readonly>
                                                                                    ...
                                                                                    <div class="col-md-12 mb-4">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            name="project_name"
                                                                                            class="form-control"
                                                                                            value="<?= htmlspecialchars($row['project_id']); ?>"
                                                                                            required>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-6 mb-4">
                                                                                        ...
                                                                                        <select name="payment_method"
                                                                                            ...
                                                                                            <option value="Cash"
                                                                                                <?= ($row['payment_method'] == 'Cash') ? 'selected' : ''; ?>>
                                                                                                Cash
                                                                                            </option>

                                                                                            <option value="Check"
                                                                                                <?= ($row['payment_method'] == 'Check') ? 'selected' : ''; ?>>
                                                                                                Check
                                                                                            </option>

                                                                                            <option value="Bank Transfer"
                                                                                                <?= ($row['payment_method'] == 'Bank Transfer') ? 'selected' : ''; ?>>
                                                                                                Bank Transfer
                                                                                            </option>
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <button type="submit" name="update_expenditure"
                                                                            class="btn text-white"
                                                                            style="background-color:rgb(134,9,9);">
