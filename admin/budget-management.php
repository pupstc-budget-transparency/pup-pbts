...
$sql = "
    ...
    FROM budgets
    LEFT JOIN users
        ON budgets.created_by = users.user_id
    WHERE
    budgets.record_status = 'active'
    AND
    (
        budgets.budget_title LIKE '%$search%'
        OR budgets.fiscal_year LIKE '%$search%'
    )
    ORDER BY budgets.budget_id DESC
    LIMIT $offset, $limit
";
...
<body>
    ...
    <div class="container-fluid px-0">
        <div class="row g-0">
            <div class="col-12 col-xl-2 col-md-1 col-sm-1 ">
            ...
            <div class="col-12 col-xl-10 col-md-11 col-sm-11">
                <div class="row g-0">
                ...
                <div class="row g-0">
                    <div class="col-12 col-xl-6 p-2 mt-3">
                        <div class="d-flex justify-content-start ">
                            <a href="add-budget.php" class="btn text-light px-4 py-2 shadow border border-gray"
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive ">
                                                <table class="table users-table align-middle table-striped ">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php while ($row = mysqli_fetch_assoc($query)) { ?>
                                                            ...
                                                            <tr>
                                                                <td data-label="ID"><?= $row['budget_id']; ?></td>
                                                                <td data-label="Budget Title"><?= $row['budget_title']; ?></td>
                                                                <td data-label="Fiscal Year"><?= $row['fiscal_year']; ?></td>
                                                                <td data-label="Total Amount">₱<?= number_format($row['total_amount'], 2); ?></td>
                                                                <td data-label="Created By"><?= $row['fullname']; ?></td>

                                                                <td data-label="Status">
                                                                    <?php if ($row['record_status'] == 'active') { ?>
                                                                ...
                                                                <td data-label="Action">
                                                                    ...
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <button class="btn action-btn text-dark me-2"
                                                                            ...
                                                                            data-bs-target="#editModal<?= $row['budget_id']; ?>">
                                                                        ...
                                                                        <button class="btn action-btn text-light"
                                                                            ...
                                                                            data-bs-toggle="modal"
                                                                            data-bs-target="#deleteModal<?= $row['budget_id']; ?>">
                                                ...
                                                ?>
                                                    ...
                                                    <div class="modal fade" id="deleteModal<?= $row['budget_id']; ?>"
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body text-center">
                                                                    ...
                                                                    <p class="mt-3">
                                                                        ...
                                                                        <strong><?= htmlspecialchars($row['budget_title']); ?></strong>?
                                                                    </p>

                                                                    <small class="text-muted">
                                                                        This budget will be hidden from active records but
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form method="POST">
                                                                        ...
                                                                        <button type="submit" name="delete_budget"
                                                    ...
                                                    <div class="modal fade" id="editModal<?= $row['budget_id']; ?>"
                                                        tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false">
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-6 mb-4">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            name="budget_title"
                                                                                            class="form-control"
                                                                                            value="<?= htmlspecialchars($row['budget_title']); ?>"
                                                                                            required>
                                                                                ...
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-md-12 mb-4">
                                                                                        ...
                                                                                        <textarea name="purpose"
                                                                                            ...
                                                                                            required><?= htmlspecialchars($row['purpose']); ?></textarea>
                                                                                    ...
                                                                                    <div class="col-md-12 mb-4">
                                                                                        ...
                                                                                        <input type="text"
                                                                                            name="beneficiaries"
                                                                                            class="form-control"
                                                                                            value="<?= htmlspecialchars($row['beneficiaries']); ?>"
                                                                                            required>

                                                                                        <small class="text-muted">
                                                                                            State who will benefit from this
                                                                                            budget.
                                                                                        </small>
                                                                                    ...
                                                                                    <div class="col-md-12 mb-4">
                                                                                        ...
                                                                                        <textarea name="expected_outcome"
                                                                                            class="form-control" rows="3"
                                                                                            required><?= htmlspecialchars($row['expected_outcome']); ?></textarea>

                                                                                        <small class="text-muted">
                                                                                            Example: Improved learning
